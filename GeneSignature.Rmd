...
dataIn<-read.csv("/home/asif/Desktop/CenturiWork/clustering/8Feb2022/ApplicationData/RareCNVsDisruptedGenes.csv", header = T, sep = ",")

dim(dataIn)
head(dataIn)
colnames(dataIn)[1] <- "genes"
dataIn$class <- "ASD"
...
SemSim_mat <- read.csv("/home/asif/Desktop/CenturiWork/clustering/8Feb2022/ApplicationData/SemSim_RareCNVsDisruptedGenes.csv", header = TRUE, sep = ",")

dim(SemSim_mat)
SemSim_mat$class <- "ASD"
...
cluster3 <- g_c_clus[g_c_clus$cluster==1, ]
dim(cluster3)
head(cluster3)
